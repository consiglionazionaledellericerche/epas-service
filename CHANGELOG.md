...
## [0.8.0] - 2025-11-19
## Added
  - Aggiunto EpasParam.HANDLE_OVERTIME per ripristinare deserializzazione parametri

### Changed
 - Aggiornamento a Spring boot 3.5.7

## [0.7.1] - 2025-09-08
## Changed
  - Corretta creazione contratti via REST in caso di altri contratti già presenti
