...
import it.cnr.iit.epas.models.PersonHourForOvertime;
import it.cnr.iit.epas.models.PersonReperibilityType;
import it.cnr.iit.epas.models.QCompetence;
...
import it.cnr.iit.epas.models.QPersonHourForOvertime;
...
public class CompetenceDao extends DaoBase<Competence> {
  ...
  public List<Competence> getAllCompetenceForPerson(Person person, Integer year, Integer month) {
    return competenceInMonth(person, year, month, Optional.<List<String>>empty());
  }
