...
import it.cnr.iit.epas.models.QPersonShiftShiftType;
import it.cnr.iit.epas.models.QShiftCancelled;
import it.cnr.iit.epas.models.QShiftCategories;
import it.cnr.iit.epas.models.QShiftTimeTable;
import it.cnr.iit.epas.models.QShiftType;
import it.cnr.iit.epas.models.ShiftCancelled;
 ...
 */
@Component
public class ShiftDao extends DaoBase<PersonShift> {

  @Inject
  ShiftDao(ObjectProvider<EntityManager> emp) {
    super(emp);
