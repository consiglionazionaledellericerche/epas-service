...
public enum EpasParam {
  ...
  DAY_OF_PATRON("dayOfPatron",
      ...
      EpasParamValueType.formatValue(MonthDay.of(1, 1)),
  ...
  DATE_START_MEAL_TICKET("date_start_meal_ticket",
      ...
      EpasParamValueType.formatValue(LocalDate.of(2014, 7, 1)),
  ...
  EXPIRY_VACATION_PAST_YEAR("expiry_vacation_past_year",
      ...
      EpasParamValueType.DAY_MONTH,
      EpasParamValueType.formatValue(MonthDay.of(8, 31)),
      Lists.<RecomputationType>newArrayList(),
      Office.class),
  ...
  HOUR_MAX_TO_CALCULATE_WORKTIME("hour_max_to_calculate_worktime",
      ...
      EpasParamValueType.formatValue(LocalTime.of(5, 0)),
      Lists.newArrayList(RecomputationType.DAYS, RecomputationType.RESIDUAL_HOURS,
          RecomputationType.RESIDUAL_MEALTICKETS),
      Office.class),
  ...
  WORK_INTERVAL_MISSION_DAY("work_interval_mission_day",
      ...
      EpasParamValueType
      .formatValue(new LocalTimeInterval(LocalTime.of(7, 0), LocalTime.of(19, 0))),
      Lists.newArrayList(RecomputationType.DAYS, RecomputationType.RESIDUAL_HOURS,
          RecomputationType.RESIDUAL_MEALTICKETS),
      Office.class),
  ...
  LUNCH_INTERVAL("lunch_interval",
      ...
      EpasParamValueType.LOCALTIME_INTERVAL,
      EpasParamValueType
      .formatValue(new LocalTimeInterval(LocalTime.of(12, 0), LocalTime.of(15, 0))),
      Lists.newArrayList(RecomputationType.DAYS, RecomputationType.RESIDUAL_HOURS,
          RecomputationType.RESIDUAL_MEALTICKETS),
      Office.class),
  ...
  WORK_INTERVAL("work_interval",
      ...
      EpasParamValueType.LOCALTIME_INTERVAL,
      EpasParamValueType
      .formatValue(new LocalTimeInterval(LocalTime.of(0, 0), LocalTime.of(23, 59))),
      Lists.newArrayList(RecomputationType.DAYS, RecomputationType.RESIDUAL_HOURS,
          RecomputationType.RESIDUAL_MEALTICKETS),
      Office.class),
