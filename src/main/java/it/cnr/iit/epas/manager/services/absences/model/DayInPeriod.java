...
public class DayInPeriod {
  ...
  private static String formatAmount(long amount, AmountType amountType) {
    if (amountType == null) {
      return "";
    }
    String format = "";
    if (amountType.equals(AmountType.units)) {
      ...
      long units = amount / 100;
      long percent = amount % 100;
    ...
    if (amountType.equals(AmountType.minutes)) {
      ...
      long hours = amount / 60; //since both are ints, you get an int
